...
namespace District_3_App_Tests.ServiceTests
{
    public class ProfileNetworkInfoServiceTests
    {
        ...
        public void RemoveProfileSocialNetworkInfo_ShouldReturnTrue()
        {
            ...
            // Arrange
            var service = new ProfileNetworkInfoService(groupsRepository, profileNetworkInfoRepository, usersRepository);
            var profileToRemove = new UserProfileSocialNetworkInfo();

            // First, add the profile to the service
            service.AddProfileSocialNetworkInfo(profileToRemove);

            // Act
            var result = service.RemoveProfileSocialNetworkInfo(profileToRemove);
        ...
        public void RemoveProfileSocialNetworkInfo_ShouldReturnFalse()
        {
            ...
            // Arrange
            var service = new ProfileNetworkInfoService(groupsRepository, profileNetworkInfoRepository, usersRepository);
            var profileToRemove = new UserProfileSocialNetworkInfo(); // A profile that doesn't exist in the repository
