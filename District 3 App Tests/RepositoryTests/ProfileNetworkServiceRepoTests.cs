...
{
    public class ProfileNetworkServiceRepoTests
    {
        [Fact]
        public void AddProfileSocialNetworkInfo_NewValidProfile_ShouldReturnTrue()
        {
            ...
            // Arrange
            ProfileNetworkInfoRepository<UserProfileSocialNetworkInfo> repository = new ProfileNetworkInfoRepository<UserProfileSocialNetworkInfo>(profiles);
            ...
            // Act
            var result = repository.AddProfileSocialNetworkInfo(profile);
        ...
        [Fact]
        public void DeleteProfileSocialNetworkInfo_ProfileExists_ShouldReturnTrue()
        {
            // Create mock users
            User user1 = new User(Guid.NewGuid(), "user1", "password1", "user1@example.com", "password1Confirmation");
            User user2 = new User(Guid.NewGuid(), "user2", "password2", "user2@example.com", "password2Confirmation");
            ...
            // Act
            var result = repository.RemoveProfileSocialNetworkInfo(profile);
        ...
        [Fact]
        public void DeleteProfileSocialNetworkInfo_ProfileDoesntExist_ShouldReturnTrue()
        {
            // Create mock users
            User user1 = new User(Guid.NewGuid(), "user1", "password1", "user1@example.com", "password1Confirmation");
            User user2 = new User(Guid.NewGuid(), "user2", "password2", "user2@example.com", "password2Confirmation");
            ...
            ProfileNetworkInfoRepository<UserProfileSocialNetworkInfo> repository = new ProfileNetworkInfoRepository<UserProfileSocialNetworkInfo>(profiles);
            UsersRepository usersRepository = new UsersRepository(new List<User> { user1, user2, user3, user4 });
            var profile = new UserProfileSocialNetworkInfo(user3, blockedProfiles3, closeFriends3, new List<Group>(), restrictedStoriesAudience3, restrictedPostsAudience3);
